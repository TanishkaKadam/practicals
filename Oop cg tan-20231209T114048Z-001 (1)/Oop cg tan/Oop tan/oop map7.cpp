...
int main()
{
	...
	populationMap.insert(pair<string, int>("Tamil Nadu", 8276291));
	populationMap.insert(pair<string, int>("Delhi", 2234291));
	populationMap.insert(pair<string, int>("Goa", 57661));
	populationMap.insert(pair<string, int>("Kerala", 4476721));
	populationMap.insert(pair<string, int>("Gujarat", 74643567));
